...
An axon is a prolongation of a cell (Figure 6.14). As in all cells, the cytoplasmic $\mathsf { K } ^ { + }$ concentration (about 150 mmol $\mathsf { I } ^ { - 1 } )$ is considerably greater than that outside (in the interstitial fluid and plasma – about 5 mmol $\mathsf { I } ^ { - 1 } )$ . The nerve cell membrane is selectively permeable to $\mathsf { K } ^ { + }$ ions, which therefore diffuse out (through specific $\mathsf { K } ^ { + }$ channels) down their concentration gradient. They take with them positive charge – leaving the interior of the cell with a negative charge relative to the outside. This is known as the resting membrane potential. It can be measured with a voltmeter in a large nerve and is about $\mathtt { - 7 0 }$ mV. (The negative sign is conventional, implying that the inside is negatively charged with respect to the outside.) $\mathsf { N a } ^ { + }$ ions have the opposite distribution: they are present at higher concentration outside (about 150 mmol $| ^ { - 1 } \bigr )$ than inside (about 15 mmol $\mathsf { I } ^ { - 1 } )$ . However, the membrane is less permeable to $\mathsf { N a } ^ { + }$ ions than to $\mathsf { K } ^ { + }$ ions, so the potential difference is maintained. In addition, nerve cell membranes contain the ${ \mathsf { N a } } ^ { + } { \mathsf { - K } } ^ { + } { \mathsf { - A T P a s e } } ,$ , which pumps out three $\mathsf { N a } ^ { + }$ ions in exchange for two $\mathsf { K } ^ { + }$ ions from outside (and uses $\mathsf { A T P }$ for this). This further maintains the resting energy potential (since there is a net outward movement of positive charge). This is illustrated in the top panel of Figure 6.1.1. 
