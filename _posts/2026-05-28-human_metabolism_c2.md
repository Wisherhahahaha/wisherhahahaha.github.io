...
concentrations (well above the $K_m$). This would be appropriate in, for instance, the brain, where the rate of glucose uptake needs to be constant despite cycles of feeding and fasting. With a $K_m$ for glucose entry of 20 mmol L⁻¹ (e.g., GLUT2), the rate of glucose entry is almost proportional to the extracellular glucose concentration (the higher the external concentration, the greater the rate of entry). Alternatively, we may describe GLUT2 as having low affinity for glucose – it is sometimes called a low-affinity transporter. We could imagine that because the affinity for glucose is low, a high concentration is needed to produce maximal transport. Conversely, GLUT3 would be a high-affinity transporter (low concentrations produce high transport rates).
